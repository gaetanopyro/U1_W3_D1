...
*/
function stringhe(pierpaolo, giovanni) {
  const firstStr = pierpaolo.slice(0, 2);
...
const result = arrayCasuale();
console.log(result);
/* ESERCIZIO 3 (filter)
  Scrivi una funzione per ricavare solamente i valori PARI da un array composto da soli valori numerici
*/
const arrayOfNumber = [10, 5, 17, 22, 40, 13];

function filterNumber(arrayNumber) {
  return arrayNumber.filter((numero) => numero % 2 === 0);
}

const numeriPari = filterNumber(arrayOfNumber);
